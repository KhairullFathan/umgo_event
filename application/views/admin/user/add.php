        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="form-group my-2">
              ...
              <select name="RoleID" id="RoleID" class="form-control">
                ...
                <?php foreach($role as $row): ?>
                  <option value="<?= $row->RoleID ?>" <?= (set_value('RoleID')==$row->RoleID)?'selected':''?>><?= $row->Role ?></option>
                <?php endforeach; ?>
              </select>
            ...
            <div class="form-group my-2">
              ...
              <textarea class="form-control" name="Alamat" id="Alamat" placeholder="Jl. Limboto Raya, Kel. , Kec. Kab."><?= set_value('Alamat') ?></textarea>
