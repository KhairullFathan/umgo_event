        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="form-group my-2">
              ...
              <select name="VenueID" id="VenueID" class="form-control">
                ...
                <?php foreach($venue as $row): ?>
                  <option value="<?= $row->VenueID ?>" <?= ($row->VenueID==$data->VenueID) ?'selected':'' ?>><?= $row->Venue ?></option>
                <?php endforeach; ?>
              </select>
            ...
            <div class="form-group my-2">
              ...
              <input type="text" class="form-control" id="Event" name="Event" value="<?= $data->Event ?>">
            ...
            <div class="form-group my-2">
              ...
              <div class="form-check mb-2">
                <input name="Presensi" class="form-check-input" type="radio" value="1" id="Aktif" <?= ($data->Presensi==1)?'checked':'' ?>>
                <label class="form-check-label" for="Aktif">Aktif</label>
              </div>
              <div class="form-check mb-2">
                <input name="Presensi" class="form-check-input" type="radio" value="0" id="TidakAktif" <?= ($data->Presensi!=1)?'checked':'' ?>>
                <label class="form-check-label" for="TidakAktif">Tidak Aktif</label>
              </div>
            </div>
            <div class="form-group my-2">
              <label for="WaktuPresensi">Waktu Presensi</label>
              <input type="datetime-local" class="form-control" id="WaktuPresensi" name="WaktuPresensi" value="<?= $data->WaktuPresensi ?>">
