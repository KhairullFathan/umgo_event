...
>
  <head>
    ...
    <title>Maintenance | Asrama UMGO</title>
  ...
  <body>
    ...
    <div class="container-xxl container-p-y">
      <div class="misc-wrapper">
        ...
        <p class="mb-4 mx-2">Mohon maaf halaman ini masih dalam tahap pengembangan!</p>
        <a href="<?=base_url('welcome')?>" class="btn btn-primary">Kembali ke login</a>
        <div class="mt-4">
          <img
